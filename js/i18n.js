...
const DejuVuI18n = (function () {
  ...
  const translations = {
    ...
    fr: {
      ...
      "svc.philosophy.block1":   "<strong>Déjà Vu Home est à votre service</strong> pour toutes les opérations, tous à l'immobilier, que ce soit <em>acheter</em> ou la <em>vente</em> de bien de prestige, <em>la location</em> d'appartements et de <em>du soutien</em>, maximum et confortables.",
    ...
    en: {
      ...
      "svc.philosophy.block1":   "<strong>Déjà Vu Home is at your service</strong> for all real estate operations, whether <em>buying</em> or <em>selling</em> prestigious properties, <em>renting</em> apartments, and providing <em>maximum</em> and comfortable <em>support</em>.",
    ...
    de: {
      ...
      "svc.philosophy.block1":   "<strong>Déjà Vu Home steht Ihnen zur Verfügung</strong> für alle Immobiliengeschäfte, sei es <em>Kauf</em> oder <em>Verkauf</em> von Prestigeimmobilien, <em>Vermietung</em> von Wohnungen und <em>maximale</em> und komfortable <em>Unterstützung</em>.",
